...
extern void parasite_setup_regs(unsigned long new_ip, void *stack, struct reg *regs);
...
extern int compel_execute_syscall(pid_t pid, struct orig *orig, struct reg *regs);
...
extern void restore_setregs(pid_t pid, struct reg orig);
