...
{
  static const InotifyWdEntry init_value = INOTIFY_WD_ENTRY__INIT;
  *message = init_value;
}
...
{
  static const InotifyFileEntry init_value = INOTIFY_FILE_ENTRY__INIT;
  *message = init_value;
}
...
{
  static const FanotifyInodeMarkEntry init_value = FANOTIFY_INODE_MARK_ENTRY__INIT;
  *message = init_value;
}
...
{
  static const FanotifyMountMarkEntry init_value = FANOTIFY_MOUNT_MARK_ENTRY__INIT;
  *message = init_value;
}
...
{
  static const FanotifyMarkEntry init_value = FANOTIFY_MARK_ENTRY__INIT;
  *message = init_value;
}
...
{
  static const FanotifyFileEntry init_value = FANOTIFY_FILE_ENTRY__INIT;
  *message = init_value;
}
