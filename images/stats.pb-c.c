...
{
  static const DumpStatsEntry init_value = DUMP_STATS_ENTRY__INIT;
  *message = init_value;
}
...
{
  static const RestoreStatsEntry init_value = RESTORE_STATS_ENTRY__INIT;
  *message = init_value;
}
...
void   stats_entry__init
                     (StatsEntry         *message)
{
  static const StatsEntry init_value = STATS_ENTRY__INIT;
  *message = init_value;
}
...
static const ProtobufCFieldDescriptor dump_stats_entry__field_descriptors[11] =
{
  {
    "freezing_time",
    1,
