...
{
  static const PacketMclist init_value = PACKET_MCLIST__INIT;
  *message = init_value;
}
...
void   packet_ring__init
                     (PacketRing         *message)
{
  static const PacketRing init_value = PACKET_RING__INIT;
  *message = init_value;
}
...
{
  static const PacketSockEntry init_value = PACKET_SOCK_ENTRY__INIT;
  *message = init_value;
}
