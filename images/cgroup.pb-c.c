...
void   cgroup_perms__init
                     (CgroupPerms         *message)
{
  static const CgroupPerms init_value = CGROUP_PERMS__INIT;
  *message = init_value;
}
...
{
  static const CgroupPropEntry init_value = CGROUP_PROP_ENTRY__INIT;
  *message = init_value;
}
...
{
  static const CgroupDirEntry init_value = CGROUP_DIR_ENTRY__INIT;
  *message = init_value;
}
...
{
  static const CgControllerEntry init_value = CG_CONTROLLER_ENTRY__INIT;
  *message = init_value;
}
...
{
  static const CgMemberEntry init_value = CG_MEMBER_ENTRY__INIT;
  *message = init_value;
}
...
void   cg_set_entry__init
                     (CgSetEntry         *message)
{
  static const CgSetEntry init_value = CG_SET_ENTRY__INIT;
  *message = init_value;
}
...
void   cgroup_entry__init
                     (CgroupEntry         *message)
{
  static const CgroupEntry init_value = CGROUP_ENTRY__INIT;
  *message = init_value;
}
