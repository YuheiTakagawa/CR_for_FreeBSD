...
{
  static const WinsizeEntry init_value = WINSIZE_ENTRY__INIT;
  *message = init_value;
}
...
{
  static const TermiosEntry init_value = TERMIOS_ENTRY__INIT;
  *message = init_value;
}
...
void   tty_pty_entry__init
                     (TtyPtyEntry         *message)
{
  static const TtyPtyEntry init_value = TTY_PTY_ENTRY__INIT;
  *message = init_value;
}
...
{
  static const TtyDataEntry init_value = TTY_DATA_ENTRY__INIT;
  *message = init_value;
}
...
{
  static const TtyInfoEntry init_value = TTY_INFO_ENTRY__INIT;
  *message = init_value;
}
...
{
  static const TtyFileEntry init_value = TTY_FILE_ENTRY__INIT;
  *message = init_value;
}
